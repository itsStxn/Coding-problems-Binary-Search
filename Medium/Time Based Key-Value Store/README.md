...
If there is no item, use the right pointer to return the very previous value lower than the target.

## Time Complexity
### Set - O(1) 
It performs insertion to the dictionary.

### Get - O(log n) 
It performs a binary search.

## Space Complexity - O(n)
A dictionary is used to store all the key, values, and associated timestamps.
